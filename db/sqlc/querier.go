...
type Querier interface {
	...
	GetAssignmentByResource(ctx context.Context, resourceID int64) (Assignment, error)
	...
	ListRequestByCourse(ctx context.Context, arg ListRequestByCourseParams) ([]Request, error)
	ListRequestByUser(ctx context.Context, arg ListRequestByUserParams) ([]Request, error)
	ListResource(ctx context.Context, arg ListResourceParams) ([]Resource, error)
	ListResourceByMaterial(ctx context.Context, arg ListResourceByMaterialParams) ([]Resource, error)
